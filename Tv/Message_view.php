<?php 
  ...
  if (isset($_GET['del'])) {
    ...
    $id = $_GET['del'];
    $del_sql = "DELETE FROM tmessages WHERE Mid = $id";
    ...
    if ($del_result) {
      ...
      header("Refresh: 3; url=Message_view.php");
    }else{
...
<body>
	...
	<div style="border: 1px solid grey;height: 785px;width: 1777px;" id="main2" >
		<div class="topnav">
		  ...
		  <a href="Message_view.php" class="active">View Messages</a>
		</div>
    <h1 style="margin-left: 220px;margin-top: 30px;">All Messages</h1>
          ...
          <table border="1" class="table table-hover">
            ...
            <?php  while ($data = mysqli_fetch_assoc($res)) { ?>
                <tr>
                  ...
                  <th><a href="?del=<?php echo $data['Mid']; ?>"><span class="btn btn-danger glyphicon glyphicon-trash" onclick="return confirm('Are you sure you want to delete this item?');"></span></a></th>
                </tr>
            <?php  } ?>
          </table>
    </div>
    <div style="border: 2px dashed grey;height: 500px;width: 480px;margin-left: 10px;padding: 10px;" class="block">
      <table>
        ...
        <tr>
          <td><code style="font-size: 23px;">1. The view page is to see all the messages available inside the table.</code></td>
        </tr>
        <tr>
           <td><code style="font-size: 23px;">2. The view page contains only delete operation.</code></td>
        </tr>
         <tr>
           <td><code style="font-size: 23px;">3. By clicking on delete option you can delete perticular message from the table.</code></td>
        </tr>
        <tr>
           <td><code style="font-size: 23px;">4. If you want to edit perticular message click on 'Edit' option on nav bar.</code></td>
        </tr>
      </table>
    </div>
  </div>  
